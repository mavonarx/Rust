fn main() {
    let mut maxproduct: i32 = 0;

    let grid: [[i32; 20]; 20] = init_grid();
    //horizontal
    for row in 0..20 {
        for col in 0..(20 - 3) {
            let product =
...
fn update_max(product: i32, maxproduct: i32) -> i32 {
...
fn out_of_bound(row: i32, col: i32) -> bool {
    row >= 20 || col >= 20 || col < 0 || row < 0
}

fn init_grid() -> [[i32; 20]; 20] {
